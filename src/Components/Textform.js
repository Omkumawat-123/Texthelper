...
export default function Textform(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'black'}}>
            ...
            <button className="btn btn-primary mx-1 my-2" onClick={handleOnclick}>
                Convert To LowerCase </button>
            
            <button className="btn btn-primary mx-1 my-2" onClick={handleclearclick}>
                Clear</button>

            <button className="btn btn-primary mx-1 my-2" onClick={handleOnCopy}>
                Copy</button>
            
            
             <button className="btn btn-primary mx-1 my-2" onClick={handleExtraSpace}>
                Remove Space</button>
